...
class Config(object):
  ...
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "Hollywood_Movies_Tamil_Dubbedbot")
  ...
  SHORTLINK_API = os.environ.get('SHORTLINK_API', "b2d855aebb7ed00f5fb2d22291cdcff24eab5e13")
